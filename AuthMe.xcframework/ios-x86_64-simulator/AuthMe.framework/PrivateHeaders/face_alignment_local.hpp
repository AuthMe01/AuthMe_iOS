...
#include "face_alignment_capacity.hpp"
...
class CFaceAlignment : public IFaceAlignment
{
    public:
        ...
        std::vector<cv::Point2f> Run(const cv::Mat& inputImage, const cv::Rect2f& faceRect, cv::Mat* pResultImage = nullptr, AuthMeEngineDebugInfo* pInfo = nullptr) override;
    ...
    private:
        ...
        std::unique_ptr <ICapacity_FaceAlignment> m_pCapacityProcess = nullptr;
};
