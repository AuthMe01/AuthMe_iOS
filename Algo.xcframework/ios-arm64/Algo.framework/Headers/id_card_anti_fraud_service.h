...
EAuthMeEngineReturnCode AuthMe_IDCardAntiFraudService_SetOption(long handle, const char* pOption, const char* pValue);

const char* AuthMe_IDCardAntiFraudService_GetOption(long handle, const char* pOption);
